...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.betty.assafbz.dev.com",
                ownerName = "backend.betty.assafbz.dev.com",
                packagePath = ""
        )
)
public class CompetitionEndpoint {
    ...
    /**
     * Returns the {@link Competition} with the corresponding ID.
     *
     * @param id the ID of the entity to be retrieved
     * @return the entity with the corresponding ID
     * @throws NotFoundException if there is no {@code Competition} with the provided ID.
     */
    @ApiMethod(
            name = "get",
            path = "competition/{id}",
    ...
    /**
     * Inserts a new {@code Competition}.
     */
    @ApiMethod(
            name = "insert",
            path = "competition",
    ...
    /**
     * Updates an existing {@code Competition}.
     *
     * @param id          the ID of the entity to be updated
     * @param competition the desired state of the entity
    ...
    /**
     * Deletes the specified {@code Competition}.
     *
